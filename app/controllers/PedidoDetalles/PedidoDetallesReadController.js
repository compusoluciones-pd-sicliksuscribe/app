        ...
        .then(function (result) {
          ...
          $scope.PedidoDetalles.forEach(function (elem) {
            ...
            elem.Productos.forEach(function (item) {
              ...
              if (item.IdFabricante === 1 && elem.Productos[0].NumeroSerie === 'CREATEORDER' && elem.Productos[0].validacion === 0 && IdEsquemaRenovacion !== 8 && elem.Productos[0].Familia !== 'Academic' ){$scope.flagLCO += elem.Productos[0].IdPedido +' ';}
